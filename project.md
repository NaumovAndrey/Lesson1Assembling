...
1. Создать класс в отдельном вайле, который выводит информацию в консоль <br> *приветствие* <br> *запросы отпользователя* (3)
1. Вывести приветствие.
1. Запрос от пользователя: <br> *максимальное количество спичек* <br> *количество игроков* <br> *максимальное количество взять спичек за ход* 
